    ...
    <nav class="navbar navbar-default">
        <div>
			...
			<?php if(empty($agent[$member->type])) {?>
				<img src="__PUBLIC__/admin/img/logo.png" style="height:45px;  margin-right:10px;margin-top:10px;">
			<?php }else{ ?>
                  <img src="__ATTACHS__/uploads/<?=$member->nick_dllogo?>" style="height:60px;  margin-right:10px;">
			<?php } ?>
                </a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><!--<i class="wi wi-user color-gray"></i>-->
							...
							<?php if(empty($agent[$member->type])) {?>
				<img src="__PUBLIC__/admin/img/logo.png" style="height:35px;  margin-right:10px;">
			<?php }else{ ?>
                  <img src="__ATTACHS__/uploads/<?=$member->nick_dllogo?>" style="height:35px; margin-right:10px;border-radius:60px;">
			<?php } ?>
    ...
    <div class="sidebar-collapse left-menu">
      <div class="basemenu">
		...
		<div class="leftMenu active">
              ...
              <ul class="secondMenu">
                <li class="">
                  <a  class="J_menuItem" href="__ROOT__/manage/member/usertext">
                    <i class="secondMenuIcon"></i>
                    <span>代理商资料</span>
                  </a>
                </li>
      ...
      window.open(url);
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row J_mainContent" style="width: 100%; height: 95%; margin:  0 auto; "   id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="__ROOT__/manage/miniapp/index" frameborder="0"  seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
