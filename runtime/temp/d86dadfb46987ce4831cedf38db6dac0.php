<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\soft\Apache24\htdocs\minprogramshop/youge/admin\view\index\index.html";i:1530002543;s:74:"D:\soft\Apache24\htdocs\minprogramshop/youge/admin\view\public\header.html";i:1529650715;s:72:"D:\soft\Apache24\htdocs\minprogramshop/youge/admin\view\public\left.html";i:1529650816;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <span><img alt="image" style="background-color: #f3f3f4;border: 2px solid transparent;border-radius: 50px;" width="75" class="img-circle" src="__PUBLIC__/admin/img/profile_small.png" /></span>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" style="width: 100%; height: 95%; margin:  0 auto; "   id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="__ROOT__/admin/index/main" frameborder="0"  seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">iamguao.work(c) 2018<a href="https://xcx.mestudio.cn/" target="_blank">iamguao</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
