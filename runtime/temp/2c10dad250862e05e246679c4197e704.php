<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\soft\Apache24\htdocs\minprogramshop/youge/admin\view\miniapp\miniapp\create.html";i:1530083793;s:67:"D:\soft\Apache24\htdocs\minprogramshop/youge/admin\view\layout.html";i:1530083818;s:74:"D:\soft\Apache24\htdocs\minprogramshop/youge/admin\view\public\header.html";i:1529650715;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
                                ...
                                <div id="uploader-demo" style="max-width: 300px">
                                    ...
                                    <div id="photoList" class="uploader-list">
                                        ...
                                        <div class="file-item thumbnail">
                                            <img width="110" src="__ATTACHS__/uploads/<?=$detail['photo']?>"><input type="hidden" value="<?=$detail['photo']?>" name="photo" id="photo">
                                        </div>
                                        <?php }?>
                                    </div>
                                ...
                                <div id="uploader-demo" style="max-width: 300px">
                                    ...
                                    <div id="qrcodeList" class="uploader-list">
                                        ...
                                        <div class="file-item thumbnail"><img width="110"
                                                                              src="__ATTACHS__/uploads/<?=$detail['qrcode']?>"><input
