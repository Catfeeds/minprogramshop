<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\soft\Apache24\htdocs\minprogramshop/youge/home\view\shop\index.html";i:1529637512;s:66:"D:\soft\Apache24\htdocs\minprogramshop/youge/home\view\layout.html";i:1529646179;}*/ ?>
﻿<!DOCTYPE html>
<html dir="ltr">
	<head>
		<meta charset="utf-8">
...
<link rel="stylesheet" href="__PUBLIC__/home/css/comment.css?v=20170831"/>
<link rel="stylesheet" href="__PUBLIC__/home/css/index.css?v=201708230932"/>
<link rel="stylesheet" href="__PUBLIC__/home/css/wdetails.css"/>
                ...
                <li>
                    ...
                    <div style="display: none;" class="wxb_app_qrcode">
                          <a  href="<?=url('/home/shop/detail',['miniapp_id'=>$val->miniapp_id])?>" >
                            <img width="200" src="__ATTACHS__/uploads/<?=getImg($val->qrcode)?>"/>
                             </a>
                        </div>
                    <?php }?>
                    ...
                    <div class="wxb_app_img">
                       <a  href="<?=url('/home/shop/detail',['miniapp_id'=>$val->miniapp_id])?>" >
                           <img src="__ATTACHS__/uploads/<?=getImg($val->photo)?>" style="width: 280px; height: 188px;"></img>
                        </a>
                    </div>
