...
<html dir="ltr">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="__PUBLIC__/styles/css/aboutcss.css">
		<link type="text/css" rel="stylesheet" href="__PUBLIC__/styles/css/welcome2.css">
		<link type="text/css" rel="stylesheet" href="__PUBLIC__/styles/css/welcome3.css">
	...
	<body>
		<style>
			.m-topLogo{width: 111px;height: 35px;background: url(__PUBLIC__/styles/images/vvez7fzn5nt5fn6yc2nvjt5nyv6tq1.png) no-repeat;background-size: 111px auto;}
			.m-topLogo.solid{background: url(__PUBLIC__/styles/images/m6imenbfx85rllz5jnlixx76finzjm.png) no-repeat;background-size: 111px auto;height: 35px;}
		</style>
		...
		<div class="swiper-wrapper">
				...
				<div class="container">
					<div class="group_info">
						<div class="vertical">
							...
							<div class="inf_btns">
								<a href="__ROOT__/manage/passport/register.html" class="u-btn btn-fill" target="_blank">免费注册</a>
								<a href="__ROOT__/manage/passport/login.html" class="u-btn btn-outline" target="_blank">立即登录</a>
							</div>
						</div>
					</div>
					<div class="group_bg">
						<img class="img" src="__PUBLIC__/styles/picture/othx70mazthb7cta9ppxar9k7rbbr8.png">
					</div>
				</div>
			</div>
			...
			<div class="swiper-slide view_left" style="background-color: #1242ac">
				<div class="container">
					...
					<div class="group_bg">
						<img class="img" src="__PUBLIC__/styles/picture/sj6jzyhwjj064qcwsj3yv4vczhd06q.png">
					</div>
				</div>
			</div>
			...
			<div class="swiper-slide view_left" style="background-color: #181647">
				<div class="container">
					...
					<div class="group_bg">
						<img class="img" src="__PUBLIC__/styles/picture/ii5cmja7m17jn8yr5adztrrg55d7j5.png">
					</div>
				</div>
			</div>
			<div class="swiper-slide view_left" style="background-color: #181647">
				<div class="container">
					...
					<div class="group_bg">
						<img class="img" src="__PUBLIC__/styles/picture/qkrqzrior1loq3gml1idqaqt1cm34o.jpg">
					</div>
				</div>
			</div>
			<!--<div class="swiper-slide view_left" style="background-color: #181647">
	...
	<div class="g-section__main">
		<div class="m-section-value" style=" padding-bottom: 100px;">
			...
			<div class="m-section__body">
				<ul class="m-section__list">
					<li class="m-section__item">
						<p class="img"><img src="__PUBLIC__/styles/picture/value.png" width="50%"/></p>
						<p class="text">商业价值</p>
						<p class="summary">
					...
					<li class="m-section__item">
						<p class="img"><img src="__PUBLIC__/styles/picture/fast.png" width="50%"/></p>
						<p class="text">一键授权</p>
						<p class="summary">
					...
					<li class="m-section__item">
						<p class="img"><img src="__PUBLIC__/styles/picture/user.png" width="50%"/></p>
						<p class="text">用户体验</p>
						<p class="summary">
	...
	<div class="projectDesc">
		...
		<?php foreach($list as $val) { ?>
				...
				<div class="casema"><?php if(!empty($val->qrcode)){?>
					<img src="__ATTACHS__/uploads/<?=getImg($val->qrcode)?>" width="180" height="180">  <?php }?>
				</div><img style=" border-radius: 5px;border: 1px solid #E8E7E7;" src="__ATTACHS__/uploads/<?=getImg($val->photo)?>" width="100%">
				<div class="p15">
			...
			<div class="scenes wrap">
				<ul class="clearfix" style="width: 1080px;">
					<li class="li-2">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/canyin.png);"></span>
					</li>
					...
					<li class="li-2">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/dianshang1.png);"></span>
					</li>
					...
					<li class="li-2">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/fangchan.png);"></span>
					</li>
					...
					<li class="li-2">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/gssx.png);"></span>
					</li>
					...
					<li class="li-2">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/hongbei.png);"></span>
					</li>
					...
					<li class="li-2">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/jiaju.png);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/jianshen.png);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/jinrong.jpg);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/jiaoyu.png);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/meijia.png);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/meirong.png);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/muying.png);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/qiche.png);"></span>
					</li>
					...
					<li class="li-2" style="text-align: center;margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/sheying.png);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/zhubao.png);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/jiafang.png);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/xbfs.png);"></span>
					</li>
					...
					<li class="li-2" style="margin-top: 1%;">
						...
						<span style="background-image: url(__PUBLIC__/styles/images/hangye1.png);"></span>
					</li>
...
<div class="g-section g-section-choice">
	<div class="g-section__main">
		<div class="m-section-choice">
			...
			<div class="m-section__body">
				<p class="img">
					<img src="__PUBLIC__/styles/images/choice@2x.png" width="1000">
				</p>
			</div>
		</div>
	</div>
</div>
<script src="__PUBLIC__/styles/js/swiper.min.js"></script>
...
<link rel="stylesheet" href="__PUBLIC__/styles/css/global.css">
