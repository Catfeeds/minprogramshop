<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\soft\Apache24\htdocs\minprogramshop/youge/home\view\member\index.html";i:1530002688;s:66:"D:\soft\Apache24\htdocs\minprogramshop/youge/home\view\layout.html";i:1530072003;}*/ ?>
<!DOCTYPE html>
<html dir="ltr">
	<head>
		<meta charset="utf-8">
...
<div class="g-section intro" style="color: #ffffff;margin-top: -1px;background: url(__PUBLIC__/styles/picture/joinbg.jpg) center 100% no-repeat;background-size: cover;text-align: center;padding-bottom: 82px;">
    <div class="m-intro">
        ...
        <div class="list">
            <div class="item" style="height: 100px;margin-top: 5px;" >
                <p  style="height: 80px;color: #ffffff;font-size: 16px;font-weight: 400;margin-left: 25px;margin-right: 25px;" class="value">
                    温格科技开启小程序合伙人计划，诚邀各位共同发掘小程序千亿蓝海。2017，微信小程序元年，千亿市场等你来!                </p>
            </div>
...
<div class="j-tabContent"  style="display: block;">
    <div class="g-section g-section-whyme" >
        <div class="m-whyme">
            <h3 class="title1">为什么选择温格科技？</h3>
            <div class="items">
                <div class="itm " >
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/Accounting.png" width="120">
                    </p>
                    <p class="ttl">产品优秀</p>
                    <p class="summary" >
                        在同质化高的产品市场中<br>
                ...
                <div class="itm" >
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/Check.png" width="120">
                    </p>
                    <p class="ttl">OEM模式</p>
                    <p class="summary" >
                        服务商拥有自己的平台，为代<br>
                ...
                <div class="itm">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/MoneyTransfer.png" width="120">
                    </p>
                    <p class="ttl">收益丰厚</p>
                    <p class="summary">
                        高额的利润空间<br>
                ...
                <div class="itm ">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/Goal.png" width="120">
                    </p>
                    <p class="ttl">渠道优势</p>
                    <p class="summary">
                        保证市场的规范性<br>
                ...
                <div class="itm">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/ReceiveCash.png" width="120">
                    </p>
                    <p class="ttl">服务完善</p>
                    <p class="summary">
                        完善的营销体系和代理培训<br>
                ...
                <div class="itm ">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/SearchProperty.png" width="120">
                    </p>
                    <p class="ttl">生态共享</p>
                    <p class="summary">
                        加入我们共建小程序第三方市场<br>
    ...
    <div class="g-section g-section-return">
        <div class="m-return">
            <h3 class="title1">代理温格科技，您能获得什么？</h3>
            <div class="items">
                <div class="itm first">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/project.png" width="70">
                    </p>
                    <p class="ttl">产品支持</p>
                    <p class="summary">
                        服务商可根据第一线市
                ...
                <div class="itm">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/Resources.png" width="70">
                    </p>
                    <p class="ttl">资源支持</p>
                    <p class="summary">
                        总部各渠道获取到的资
                ...
                <div class="itm">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/materiel.png" width="70">
                    </p>
                    <p class="ttl">物料支持</p>
                    <p class="summary">
                        总部将定期更新产品物
                ...
                <div class="itm first line2">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/train.png" width="70">
                    </p>
                    <p class="ttl">培训支持</p>
                    <p class="summary">
                        多元化培训方式，帮助
                ...
                <div class="itm line2">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/market.png" width="70">
                    </p>
                    <p class="ttl">市场支持</p>
                    <p class="summary">
                        展会、交流会、发布会
                ...
                <div class="itm line2">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/address.png" width="70">
                    </p>
                    <p class="ttl">区域保护</p>
                    <p class="summary">
                        不允许服务商跨区域销
    ...
    <div class="g-section g-section-condition j-condition">
        <div class="m-condition" >
            <h3 class="title1">代理温格科技，您需要具备什么基础条件？</h3>
            <div class="items" >
                <div class="itm first">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/icon-condition1.png" width="72">
                    </p>
                    <p class="summary">
                        有互联网行业经验者优先<br>
                        具备管理经验者优先
                ...
                <div class="itm" id="auto-id-1509435496606">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/icon-condition2.png" width="72">
                    </p>
                    <p class="summary" >
                        5人及以上的销售团队，并拥有专门<br>
                        的售前技术和售后服务体系
                ...
                <div class="itm">
                    <p class="img">
                        <img src="__PUBLIC__/styles/images/icon-condition3.png" width="72">
                    </p>
                    <p class="summary">
                        认同温格科技发展前景和对形势的<br>判断，双方拥有共同的价值观
                    </p>
                </div>
            </div>
        </div>
