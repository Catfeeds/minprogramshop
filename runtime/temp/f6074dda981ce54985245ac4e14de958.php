<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\soft\Apache24\htdocs\minprogramshop/youge/home\view\shop\detail.html";i:1530077587;s:66:"D:\soft\Apache24\htdocs\minprogramshop/youge/home\view\layout.html";i:1530072003;}*/ ?>
<!DOCTYPE html>
<html dir="ltr">
	<head>
		<meta charset="utf-8">
...
<link rel="stylesheet" href="__PUBLIC__/home/css/wdetails.css?v=20170831"/>
    ...
    <div class="details_info">
        <div class="app_base">
            <div class="swiper_flashbox lt" >
                    <div class="swiper-wrapper" >
                       <img src="__ATTACHS__/uploads/<?=getImg($detail->photo)?>" width="400" href="289">
                    </div>
            </div>
            <div class="rt app_info">
                <?php if(!empty($detail->qrcode)){?>
                <div class="show_code">
                    <img width="200" src="__ATTACHS__/uploads/<?=getImg($detail->qrcode)?>"/>
                    <div>扫一扫看演示</div>
                </div>
                <?php }?>
                ...
                <div class="app_info_item">
                    ...
                    <a style="padding-left: 40px; color: red;font-weight: bold;" href="__ROOT__/home/news/detail/news_id/14.html">不懂如何使用？</a>
                </div>
            </div>
        </div>
        ...
        <div class="app_details_info">
            ...
            <div class="imgs">
                ...
                <img  style="margin: 6px 14px; width: 346px; height: 647px;" src="__ATTACHS__/uploads/<?=getImg($val->photo)?>"/>
                <?php } ?>
            ...
            <div class="info">
                ...
                <p class="text-p" style="text-indent:1em;font-size: 1rem;">
                    ...
                    <img style="width: 100%;height: 50%; max-width: 100%" alt="image" class="img-responsive" src="__ATTACHS__/uploads/<?=getImg($val->photo)?>">
                    <?php } ?>
                </p>
                <?php } ?>
            </div>
